...
var getUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                res.status(404).json(error_1.message);
                return [3 /*break*/, 3];
...
var createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nama, email, role, confPassword, password, hash, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, nama = _a.nama, email = _a.email, role = _a.role, confPassword = _a.confPassword;
                password = req.body.password;
                console.log('Received password:', password); // Tambahkan ini
                if (password !== confPassword) {
                    return [2 /*return*/, res.status(400).json({ msg: 'Password tidak sama' })];
                }
...
var updateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, email, nama, role, password, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
                _a = req.body, email = _a.email, nama = _a.nama, role = _a.role, password = _a.password;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, prisma_1.default.$transaction(function (tx) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma_1.default.$transaction(function (tx) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, tx.user.delete({
                                        where: { id: id },
                                    })];
                                case 1:
                                    _a.sent();
...
exports.default = { getUser: getUser, getUserId: getUserId, createUser: createUser, updateUser: updateUser, deleteUser: deleteUser };
